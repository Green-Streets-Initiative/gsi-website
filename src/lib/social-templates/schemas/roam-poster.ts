...
export function roamPosterSchema(_platform: Platform) {
  return z.object({
    ...
    region: z.string().max(60).optional(),                        // e.g. "Falmouth · Cape Cod"
    blurb: z.string().max(300).optional(),                        // roam description
    ...
    badgeRegion: z.string().max(20).optional(),                   // bottom arc text (e.g. "CAPE COD")
  });
}
