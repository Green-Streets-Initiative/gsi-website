...
export default function EventMap({
  ...
  const markerIcons = {
    food: '<svg width="16" height="16" viewBox="0 0 256 256" fill="white"><path d="M224,104h-8.37a88,88,0,0,0-175.26,0H32a8,8,0,0,0-8,8,104.35,104.35,0,0,0,56,92.28V216a16,16,0,0,0,16,16h64a16,16,0,0,0,16-16v-11.72A104.35,104.35,0,0,0,232,112,8,8,0,0,0,224,104Zm-24.46,0H56.46a72,72,0,0,1,143.08,0Z"/></svg>',
