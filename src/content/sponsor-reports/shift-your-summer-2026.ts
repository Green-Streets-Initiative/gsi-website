    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'offer', title: 'Your member offer', blocks: [
          ...
          ], note: 'Campaign-period figures. Your offer has continued running since and has now been shown 8,977 times to 337 people in total.' },
          { kind: 'prose', paragraphs: [
            'Honest read: reach was strong and sustained \u2014 297 people saw your brand an average of 23 times each \u2014 but the sign-up form produced no genuine leads. Getting in front of people was never the problem; asking them to fill in a form inside an app was.',
            'That is our design to fix, not your offer. For next year we would rather show a discount code directly in the app, so redeeming it takes one tap and lands on your site instead of in our form.',
          ] },
        ] },
        campaignResults,
        widerCampaign,
        lessons([{ title: 'The offer lead form did not work \u2014 we are replacing it.', body: 'Partner offers were shown thousands of times to hundreds of members and produced no genuine sign-ups. The idea was worth testing and it did not land. Next year we plan to put a discount code directly in the app instead of a form.' }]),
      ],
    },
    {
      slug: 'thousand',
      ...
      sections: [
        ...
        { id: 'offer', title: 'Your member offer', blocks: [
          ...
          { kind: 'prose', paragraphs: ['The sign-up form produced no genuine leads. Reach was not the problem; asking people to complete a form inside an app was. For next year we would rather show a discount code directly in the app, so redeeming it takes one tap and lands on your site.'] },
        ] },
        campaignResults,
        widerCampaign,
        lessons([
          { title: 'Offer end dates should match the campaign, not the calendar.', body: 'Your offer lapsed at the halfway point and missed the campaign\u2019s busiest weeks. Next year every partner offer runs to the final day by default.' },
          { title: 'The offer lead form did not work \u2014 we are replacing it.', body: 'Partner offers were shown thousands of times and produced no genuine sign-ups. Next year we plan to put a discount code directly in the app instead of a form.' },
        ]),
      ],
    },
  ],
